...
class Cobalt:
    ...
    def run(self,hits_file: Union[str,Path], aligned_file: Union[str,Path], cobalt_home: str) -> bool:
        """_summary_

        Args:
            hits_file (Union[str,Path]): Path to the blastp output
            aligned_file (Union[str,Path]): Path where to direct the Cobalt output
